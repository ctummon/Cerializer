...
namespace Cerializer {
    ...
    struct NlohmannJsonConverter
    {
        ...
        template<class T, typename std::enable_if<std::is_base_of<Cerializer::NlohmannJsonObj<T>, T >::value>::type* = nullptr>
        ...
        template<class T>
        static JsonObj::value_type fromType(const Cerializer::NlohmannJsonObj<T>& val)
        {
            return val.toJson();
        }
