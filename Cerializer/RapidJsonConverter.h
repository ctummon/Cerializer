...
namespace Cerializer
{
    ...
    struct RapidJsonConverter
    {
        ...
        template<class T, typename std::enable_if<std::is_base_of<Cerializer::RapidJsonObj<T>, T >::value>::type* = nullptr>
        ...
        //Serialize
        template <class T>
        static void fromType(rapidjson::PrettyWriter<rapidjson::StringBuffer>& writer, Cerializer::RapidJsonObj<T>& val)
        {
            val.appendJsonStr(writer);
        }

        template<class T>
        static void fromType(rapidjson::PrettyWriter<rapidjson::StringBuffer>& writer, const Cerializer::RapidJsonObj<T>& val)
        {
            val.appendJsonStr(writer);
        }
